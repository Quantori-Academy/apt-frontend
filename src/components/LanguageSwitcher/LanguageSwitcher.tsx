...
const MenuButton = React.forwardRef(function MenuButton(
  ...
  return <Button {...props} {...getButtonProps()} />;
});

export const LanguageSwitcher: React.FC<ISwitch> = ({
  language,
  ...
  return (
    <React.Fragment>
      <DropdownContext.Provider value={dropdownContextValue}>
        ...
        <Menu id="hooks-menu">
          <MenuItem onClick={() => handleChangeLanguage("RUS")}>РУС</MenuItem>
          <MenuItem onClick={() => handleChangeLanguage("ENG")}>ENG</MenuItem>
        </Menu>
